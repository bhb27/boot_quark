...
.method static synthetic access$2300(Landroid/telecom/ConnectionService;)Landroid/telecom/SomcConnectionServiceAdapterExtend;
    .locals 1
    .param p0, "x0"    # Landroid/telecom/ConnectionService;
...
.method private createConnection(Landroid/telecom/PhoneAccountHandle;Ljava/lang/String;Landroid/telecom/ConnectionRequest;ZZ)V
    ...
    :goto_1
    const-string v5, "createConnection, number: %s, state: %s, capabilities: %s"
    ...
    invoke-static {v8}, Landroid/telecom/Connection;->capabilitiesToString(I)Ljava/lang/String;
    ...
    .line 730
    .local v4, "parcelableConnection":Landroid/telecom/ParcelableConnection;
    invoke-virtual/range {v23 .. v23}, Landroid/telecom/Connection;->getExtraParams()[Ljava/lang/String;

    move-result-object v5

    invoke-virtual {v4, v5}, Landroid/telecom/ParcelableConnection;->setExtraParams([Ljava/lang/String;)V
    ...
    invoke-virtual {v5, v0, v1, v4}, Landroid/telecom/ConnectionServiceAdapter;->handleCreateConnectionComplete(Ljava/lang/String;Landroid/telecom/ConnectionRequest;Landroid/telecom/ParcelableConnection;)V
    ...
    .line 689
    .end local v4    # "parcelableConnection":Landroid/telecom/ParcelableConnection;
