...
.method public final acquireProvider(Landroid/content/Context;Ljava/lang/String;IZ)Landroid/content/IContentProvider;
    ...
    .line 4881
    .local v9, "tmpHolder":Landroid/app/IActivityManager$ContentProviderHolder;
    if-eqz v9, :cond_1

    iget-boolean v0, v9, Landroid/app/IActivityManager$ContentProviderHolder;->isTimeout:Z
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    .line 4891
    .end local v9    # "tmpHolder":Landroid/app/IActivityManager$ContentProviderHolder;
    :cond_2
    :goto_2
    if-nez v2, :cond_4
    ...
    .line 4887
    .restart local v9    # "tmpHolder":Landroid/app/IActivityManager$ContentProviderHolder;
    :cond_3
    :try_start_1
    const-string v0, "ActivityThread"
    ...
    const-string v3, "Getting provider is timed out. retry="
