...
.field static final TRANSACTION_getAvailableRestoreToken:I = 0x1f
...
.field static final TRANSACTION_isBackupServiceActive:I = 0x1e
...
.field static final TRANSACTION_setBackupServiceActive:I = 0x1d
...
.method public onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    .local v16, "_arg11":Landroid/app/backup/IFullBackupRestoreObserver;
    move-object/from16 v4, p0

    .line 253
    invoke-virtual/range {v4 .. v16}, Landroid/app/backup/IBackupManager$Stub;->fullBackupWithoutConfirm(Landroid/os/ParcelFileDescriptor;ZZZZZZZ[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Landroid/app/backup/IFullBackupRestoreObserver;)V
    ...
    .end local v16    # "_arg11":Landroid/app/backup/IFullBackupRestoreObserver;
    :cond_f
    const/4 v5, 0x0
    ...
    .line 273
    .local v8, "_arg3":Landroid/app/backup/IFullBackupRestoreObserver;
    move-object/from16 v0, p0

    invoke-virtual {v0, v5, v6, v7, v8}, Landroid/app/backup/IBackupManager$Stub;->fullRestoreWithoutConfirm(Landroid/os/ParcelFileDescriptor;Ljava/lang/String;Ljava/lang/String;Landroid/app/backup/IFullBackupRestoreObserver;)V
    ...
    .end local v8    # "_arg3":Landroid/app/backup/IFullBackupRestoreObserver;
    :cond_17
    const/4 v5, 0x0
    ...
    invoke-static {v4}, Lcom/android/internal/backup/IBackupTransport$Stub;->asInterface(Landroid/os/IBinder;)Lcom/android/internal/backup/IBackupTransport;

    move-result-object v7

    .line 303
    .local v7, "_arg2":Lcom/android/internal/backup/IBackupTransport;
    move-object/from16 v0, p0

    invoke-virtual {v0, v5, v6, v7}, Landroid/app/backup/IBackupManager$Stub;->registerTransportByName(Ljava/lang/String;Ljava/lang/String;Lcom/android/internal/backup/IBackupTransport;)V
    ...
    .end local v5    # "_arg0":Ljava/lang/String;
    .end local v6    # "_arg1":Ljava/lang/String;
    .end local v7    # "_arg2":Lcom/android/internal/backup/IBackupTransport;
    :sswitch_14
    const-string v4, "android.app.backup.IBackupManager"
    ...
    .line 339
    .local v20, "_result":Landroid/content/Intent;
    invoke-virtual/range {p3 .. p3}, Landroid/os/Parcel;->writeNoException()V
    ...
    .line 351
    .end local v5    # "_arg0":Ljava/lang/String;
    .end local v20    # "_result":Landroid/content/Intent;
    :sswitch_18
    const-string v4, "android.app.backup.IBackupManager"
    ...
    .line 393
    .local v20, "_result":Landroid/app/backup/IRestoreSession;
    invoke-virtual/range {p3 .. p3}, Landroid/os/Parcel;->writeNoException()V

    .line 394
    if-eqz v20, :cond_1b

    invoke-interface/range {v20 .. v20}, Landroid/app/backup/IRestoreSession;->asBinder()Landroid/os/IBinder;
    ...
    .end local v5    # "_arg0":Ljava/lang/String;
    .end local v6    # "_arg1":Ljava/lang/String;
    .end local v20    # "_result":Landroid/app/backup/IRestoreSession;
    :sswitch_1c
    const-string v4, "android.app.backup.IBackupManager"
