...
.method public updateAppWidgetSize(Landroid/os/Bundle;IIIIZ)V
    ...
    invoke-static {v12, v13, v8}, Landroid/appwidget/AppWidgetHostView;->getDefaultPaddingForWidget(Landroid/content/Context;Landroid/content/ComponentName;Landroid/graphics/Rect;)Landroid/graphics/Rect;
    ...
    .line 281
    .local v5, "newMinHeight":I
    if-eqz p6, :cond_2

    const/4 v10, 0x0

    .end local v10    # "xPaddingDips":I
    :cond_2
    sub-int v4, p4, v10

    .line 282
    .local v4, "newMaxWidth":I
    if-eqz p6, :cond_3

    const/4 v11, 0x0

    .end local v11    # "yPaddingDips":I
    :cond_3
    sub-int v3, p5, v11

    .line 283
    .local v3, "newMaxHeight":I
    if-ltz v6, :cond_4
    ...
    const-string/jumbo v13, "paddinged width or height is under 0. newMinWidth:"
    ...
    const-string v12, "AppWidgetHostView"
    ...
    .end local v3    # "newMaxHeight":I
    .end local v4    # "newMaxWidth":I
    .end local v5    # "newMinHeight":I
    .end local v6    # "newMinWidth":I
    .restart local v10    # "xPaddingDips":I
    .restart local v11    # "yPaddingDips":I
    :cond_5
    move v12, v10
    ...
    .restart local v6    # "newMinWidth":I
    :cond_6
    move v12, v11
    ...
    .end local v10    # "xPaddingDips":I
    .end local v11    # "yPaddingDips":I
    .restart local v3    # "newMaxHeight":I
    .restart local v4    # "newMaxWidth":I
    .restart local v5    # "newMinHeight":I
    :cond_7
    if-gez v6, :cond_8
    ...
    iget v12, p0, Landroid/appwidget/AppWidgetHostView;->mAppWidgetId:I

    invoke-virtual {v9, v12}, Landroid/appwidget/AppWidgetManager;->getAppWidgetOptions(I)Landroid/os/Bundle;

    move-result-object v7

    .line 302
    .local v7, "oldOptions":Landroid/os/Bundle;
    const/4 v2, 0x0
    ...
    invoke-virtual {p1, v12, v6}, Landroid/os/Bundle;->putInt(Ljava/lang/String;I)V

    .line 312
    const-string v12, "appWidgetMinHeight"

    invoke-virtual {p1, v12, v5}, Landroid/os/Bundle;->putInt(Ljava/lang/String;I)V

    .line 313
    const-string v12, "appWidgetMaxWidth"

    invoke-virtual {p1, v12, v4}, Landroid/os/Bundle;->putInt(Ljava/lang/String;I)V

    .line 314
    const-string v12, "appWidgetMaxHeight"

    invoke-virtual {p1, v12, v3}, Landroid/os/Bundle;->putInt(Ljava/lang/String;I)V
